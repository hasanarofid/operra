        ...
        <div v-if="showLauncher" class="py-8 md:py-12">
            <div class="max-w-4xl mx-auto px-4">
                <div class="text-center mb-10 md:mb-12">
                    <h2 class="text-2xl md:text-3xl font-black text-white md:text-gray-800 md:dark:text-white uppercase tracking-tighter">Selamat Datang di Operra</h2>
                    <p class="text-white/80 md:text-gray-500 md:dark:text-gray-400 mt-2 text-sm">Silahkan pilih portal CRM yang ingin Anda akses hari ini.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    <div 
                        ...
                        class="group cursor-pointer bg-white dark:bg-gray-800 rounded-[32px] p-6 md:p-8 shadow-xl hover:shadow-2xl border-2 border-transparent hover:border-operra-500 transition-all duration-300 transform hover:-translate-y-2 active:scale-95"
                    >
                        ...
                        <div class="flex items-center text-operra-500 font-black text-[10px] md:text-sm group-hover:gap-2 transition-all uppercase tracking-widest">
                            Masuk ke Portal 
