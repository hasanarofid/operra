...
<template>
    <GuestLayout>
        ...
        <div class="mb-10 text-center px-2">
            <h2 class="text-3xl font-black text-white uppercase tracking-tighter mb-2 leading-none">Hubungi Sales</h2>
            <p class="text-gray-400 text-sm font-medium">Ceritakan kebutuhan CRM Anda dan tim kami akan segera menghubungi Anda.</p>
        </div>
