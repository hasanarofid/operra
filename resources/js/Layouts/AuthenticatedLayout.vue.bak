...
<template>
    <div>
        <!-- Sidebar -->
        <nav
            class="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-white dark:bg-gray-800 flex flex-wrap items-center justify-between relative md:w-64 z-50 py-2 md:py-4 px-4 md:px-6"
        >
            <div
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <span
                            class="text-operra-600 dark:text-operra-400 font-black tracking-tighter text-lg"
                            >OPERRA</span
                        >
                    </Link>
                ...
                <div class="flex flex-col w-full">
                    ...
                    >
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-operra-600 dark:text-operra-400 font-black"
                                >OPERRA</span
                            >
                        </div>
                    </Link>
                    ...
                    >
                        <div class="flex flex-col">
                            <span
                                class="text-[9px] md:text-[10px] uppercase font-black text-gray-400 group-hover:text-operra-400 transition-colors tracking-widest leading-none mb-1"
                                >Active App</span
                            >
                            <span
                                class="text-xs md:text-sm font-bold text-gray-700 dark:text-gray-200"
                            >
                                {{ getPortalName(currentPortal) }}
                            </span>
                        </div>
                        <svg
                            class="w-4 h-4 text-gray-400 group-hover:text-operra-500 transition-colors"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                ...
                >
                    ...
                    >
                            ...
                            <Link
                                ...
                                :class="
                                    route().current('dashboard')
                                        ? 'text-operra-500 hover:text-operra-600'
                        ...
                        <template v-if="currentPortal === 'wa_blast'">
                            ...
                            <li
                                v-if="hasMinimumPlan('business-pro')"
                                class="items-center"
                            >
                                <Link
                        ...
                        <template v-if="currentPortal === 'marketing_crm'">
                            ...
                            <li class="items-center">
                                <Link
                                    :href="
                                        route('crm.marketing.campaigns.index')
                                    "
                                    class="text-xs uppercase py-2 font-bold block transition-colors duration-200"
                                    :class="
                                        route().current(
                        ...
                        <template v-if="currentPortal === 'customer_service'">
                            ...
                            <li class="items-center">
                                <Link
                                    :href="
                                        route('crm.support.chat-history.index')
                                    "
                                    class="text-xs uppercase py-2 font-bold block transition-colors duration-200"
                                    :class="
                                        route().current(
                                            'crm.support.chat-history.*',
                                        )
                                            ? 'text-operra-500'
                                            : 'text-gray-700 dark:text-gray-300 hover:text-operra-500'
                                    "
                            ...
                            <li class="items-center">
                                <Link
                                    :href="
                                        route(
                                            'crm.support.knowledge-base.index',
                                        )
                                    "
                                    class="text-xs uppercase py-2 font-bold block transition-colors duration-200"
                                    :class="
                            ...
                            <Link
                                ...
                                :class="
                                    route().current('profile.edit')
                                        ? 'text-operra-500 border-l-4 border-operra-500 pl-3'
                                        : 'text-gray-700 dark:text-gray-300 hover:text-operra-500'
                                "
                            >
                                Profile Settings
        ...
        <!-- Main Content -->
        <div
            class="relative md:ml-64 bg-gray-100 dark:bg-gray-900 min-h-screen transition-colors duration-300"
        >
